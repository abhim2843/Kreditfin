...
const whyCards = [
  { title: "Lower Interest Rates", desc: "Find lenders offering more competitive home loan rates." },
  { title: "Reduced EMIs", desc: "Lower your monthly financial burden." },
  { title: "Better Loan Terms", desc: "Access flexible repayment options and benefits." },
  { title: "Dedicated Assistance", desc: "Expert support throughout the transfer process." },
];
...
const whyIcons = [
  ...
  // reduced EMIs (trending down)
  <svg key="1" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M3 7l6 6 4-4 7 7M21 16v-5M21 16h-5" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // better loan terms (document/check)
  <svg key="2" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM14 2v6h6M9 14l2 2 4-4" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // support (headset)
...
const beforeRows = ["Limited lender options", "Generic recommendations", "Slow Approval Process", "Hidden complexities"];
const afterRows = ["Multiple lender comparison", "Personalized recommendations", "Faster approvals", "Transparent process"];
...
const tips = [
  ...
  "Transfer Early To Maximize Long-Term Interest Savings",
  "Expert Guidance Helps You Find Better Loan Options",
  "Maintain Stable Banking Records",
  "Choose A Loan Tenure That Fits Your Goals",
];

const quickSteps = [
  { title: "Share Your Loan Details", desc: "Provide your current loan information." },
  { title: "Compare The Best Offers", desc: "We identify suitable lenders and rates." },
  { title: "Start Saving More", desc: "Transfer your loan and enjoy reduced EMIs." },
];
...
const faqs = [
  {
    ...
    answer:
      "A Home Loan Balance Transfer lets you move your existing home loan from your current lender to another offering a lower interest rate and better repayment terms.",
  },
  {
    question: "How much can I save with a balance transfer?",
    answer:
      "Even a small reduction in your interest rate can save lakhs over the loan tenure. Customers often cut their EMI noticeably and reduce total interest paid.",
  },
  {
    question: "Is there a cost to transfer my home loan?",
    answer:
      "There may be processing fees from the new lender and minor charges, but the long-term interest savings usually outweigh these costs. Our experts help you compare.",
  },
  {
    question: "When is the best time to transfer my home loan?",
    answer:
      "Transferring earlier in your loan tenure maximizes savings, since a larger share of your EMI still goes toward interest. But it can benefit you at any stage.",
  },
  {
    question: "How long does a balance transfer take?",
    answer:
      "The process typically takes 7–15 business days, including document verification and approval from the new lender. We help expedite every step.",
  },
];
...
export default function HomeLoanBalanceTransferPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full relative overflow-hidden bg-[#fdfdfd]">
        {/* Right illustration — fills the right side, bleeding to the viewport edge (desktop) */}
        <div className="hidden lg:block absolute right-0 top-0 bottom-0 w-[62%] max-w-[1040px]">
          <Image
            src="/assets/hlbt-hero-illustration.png"
            alt="Home loan balance transfer"
            fill
            priority
            sizes="62vw"
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px] py-12 lg:py-0 flex flex-col lg:flex-row items-center lg:min-h-[480px]">
          <div className="flex flex-col gap-6 w-full lg:max-w-[560px] z-10">
            <h1 className="text-[30px] sm:text-[44px] lg:text-[52px] font-extrabold leading-[38px] sm:leading-[54px] lg:leading-[60px]">
              <span className="text-[#1a1f2e]">Home Loan Balance Transfer</span><br /><span className="text-[#4caf50]">Switch & Save More</span>
            </h1>
            <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[26px] sm:leading-[30px] max-w-[510px]">
              Move your existing home loan to a lender offering lower interest rates and better terms — reduce your EMI and save on total interest.
            </p>
          ...
          <div className="lg:hidden w-full relative aspect-[1186/586] mt-6">
            <Image src="/assets/hlbt-hero-illustration.png" alt="Home loan balance transfer" fill priority sizes="100vw" className="object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 lg:px-[100px] text-center">
          <h2 className="text-[26px] sm:text-[32px] font-bold text-[#1a1f2e] leading-[34px] sm:leading-[40px]">What is Home Loan Balance Transfer?</h2>
          <p className="text-[15px] sm:text-[18px] text-[rgba(26,31,46,0.7)] mt-4 leading-[26px] sm:leading-[30px]">
            A Home Loan Balance Transfer allows you to move your existing home loan from one lender to another offering better interest rates and repayment terms. This helps reduce your EMI burden, save on interest, and become debt-free faster.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="See How Home Loan Balance Transfer Works" sub="Understand how transferring your existing home loan can reduce interest costs and help you become debt-free faster." />
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Why Choose Kreditfin for Home Loan Balance Transfer" sub="We combine creative thinking with data-driven strategies to deliver results that matter for your financial journey." />
      ...
      <section className="w-full py-12 sm:py-16" style={{ background: "#eef7ee" }}>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Tips To Maximize Your Savings" sub="Reach out to us through the contact details below" />
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 shadow-[0_4px_40px_rgba(0,0,0,0.06)] flex flex-col gap-5">
              <LeadForm subject="New KreditFin enquiry (Home Loan Balance Transfer)" />
            </div>
          </div>
        </div>
      </section>
