...
const whyCards = [
  { title: "Lower Interest Rates", desc: "Competitive rates tailored to your business." },
  { title: "Higher Loan Amounts", desc: "Access funding that matches your business ambitions." },
  { title: "Multiple Lender Options", desc: "Compare offers from multiple lenders." },
...
const whyIcons = [
  ...
  // higher eligibility (trending up)
  <svg key="1" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M3 17l6-6 4 4 7-7M21 8v5M21 8h-5" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // multiple lenders (compare)
  <svg key="2" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M3 6h13M3 12h9M3 18h13M18 9l3 3-3 3" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // support (headset)
...
const beforeRows = ["Limited lender options", "Lengthy Documentation", "Slow Approval Process", "Generic Solutions"];
const afterRows = ["Multiple lender comparison", "Minimal Paperwork", "Faster approvals", "Personalized Guidance"];
...
const tips = [
  ...
  "File GST & Tax Returns On Time",
  "Keep Business Financials Updated",
  "Improve Business Credit Profile",
  "Maintain Stable Banking Records",
  "Minimize Existing Financial Obligations and Outstanding Debts",
];

const quickSteps = [
  { title: "Share Your Business Details", desc: "Provide your current business and loan information." },
  { title: "Compare The Best Offers", desc: "We identify suitable lenders and rates." },
  { title: "Receive Your Funds", desc: "Choose the best offer and access funds quickly." },
];
...
const faqs = [
  {
    ...
    answer:
      "A Business Loan provides funding to help businesses manage working capital, expand operations, purchase inventory, upgrade equipment, hire talent, or seize new growth opportunities.",
  },
  {
    question: "What types of business loans are available?",
    answer:
      "We help you access working capital loans, business expansion loans, machinery loans, and invoice financing — matched to your business profile and requirements.",
  },
  {
    question: "Do I need collateral for a business loan?",
    answer:
      "It depends on the loan type and amount. Many business loans are unsecured, while larger amounts may require collateral. Our experts help you find the right fit.",
  },
  {
    question: "What documents are required?",
    answer:
      "Typically business registration proof, GST and tax returns, bank statements, and financial statements. We guide you through the exact list for your lender.",
  },
  {
    question: "How long does approval take?",
    answer:
      "With complete documentation, business loans are usually approved within a few business days. Our team works to expedite the process at every step.",
  },
];
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full relative overflow-hidden bg-[#fdfdfd]">
        ...
        <div className="hidden lg:block absolute right-[2%] top-1/2 -translate-y-1/2 w-[40%] max-w-[600px] h-full max-h-[440px]">
          <Image
            src="/assets/business-loan-hero-illustration.png"
            alt="Business loan"
            fill
            priority
            sizes="40vw"
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px] py-12 lg:py-0 flex flex-col lg:flex-row items-center lg:min-h-[480px]">
          <div className="flex flex-col gap-6 w-full lg:max-w-[560px] z-10">
            <h1 className="text-[30px] sm:text-[44px] lg:text-[52px] font-extrabold leading-[38px] sm:leading-[54px] lg:leading-[60px]">
              <span className="text-[#1a1f2e]">Business Loans</span><br /><span className="text-[#4caf50]">Fuel Your Growth</span>
            </h1>
            <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[26px] sm:leading-[30px] max-w-[510px]">
              Get the right funding to manage working capital, expand operations, or seize growth opportunities — from leading banks and NBFCs.
            </p>
          ...
          <div className="lg:hidden w-full relative aspect-[1014/745] mt-6">
            <Image src="/assets/business-loan-hero-illustration.png" alt="Business loan" fill priority sizes="100vw" className="object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 lg:px-[100px] text-center">
          <h2 className="text-[26px] sm:text-[32px] font-bold text-[#1a1f2e] leading-[34px] sm:leading-[40px]">What is Business Loan?</h2>
          <p className="text-[15px] sm:text-[18px] text-[rgba(26,31,46,0.7)] mt-4 leading-[26px] sm:leading-[30px]">
            A Business Loan provides funding to help businesses manage working capital, expand operations, purchase inventory, upgrade equipment, hire talent, or seize new growth opportunities. Kreditfin helps connect you with the right lenders and financing solutions based on your business profile and requirements.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="See How Business Loan Works" sub="Understand the simple process of applying for a business loan and receiving funds quickly for your business needs." />
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Why Choose Kreditfin for Business Loan" sub="We combine creative thinking with data-driven strategies to deliver results that matter for your financial journey." />
      ...
      <section className="w-full py-12 sm:py-16" style={{ background: "#eef7ee" }}>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Tips To Get Business Loan Approval" sub="Reach out to us through the contact details below" />
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 shadow-[0_4px_40px_rgba(0,0,0,0.06)] flex flex-col gap-5">
              <LeadForm subject="New KreditFin enquiry (Business Loans)" />
            </div>
          </div>
        </div>
      </section>
