...
const whyCards = [
  { title: "Debt Optimization", desc: "Reduce financial burden through smarter debt allocation." },
  { title: "Cash Flow Planning", desc: "Improve liquidity and monthly cash flow." },
  { title: "Growth Focused", desc: "Structure finances for future expansion." },
  { title: "Dedicated Assistance", desc: "Dedicated support throughout the application process." },
];

const whyIcons = [
  // debt optimization (percent down)
  <svg key="0" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M19 5L5 19M8.5 8.5a2 2 0 11-4 0 2 2 0 014 0zM19.5 15.5a2 2 0 11-4 0 2 2 0 014 0z" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // cash flow (refresh / flow)
  <svg key="1" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M21 12a9 9 0 01-9 9 9 9 0 01-6.7-3M3 12a9 9 0 019-9 9 9 0 016.7 3M3 4v5h5M21 20v-5h-5" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // growth (trending up)
  <svg key="2" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M3 17l6-6 4 4 7-7M21 8v5M21 8h-5" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // support (headset)
...
const quickSteps = [
  { title: "Share Your Details", desc: "Provide your current financial information." },
  { title: "Compare The Best Options", desc: "We identify suitable strategies and structures." },
  { title: "Receive Your Plan", desc: "Choose the best structure and act with confidence." },
];

const faqs = [
  {
    question: "What is Financial Structuring?",
    answer:
      "Financial Structuring is the process of organizing your loans, assets, liabilities, cash flows, and financing arrangements to improve financial efficiency and achieve long-term financial goals. The right structure can reduce costs, improve liquidity, and support future growth.",
  },
  {
    question: "Who can benefit from Financial Structuring?",
    answer:
      "Individuals, professionals, and business owners can all benefit. Whether you want to reduce debt costs, improve cash flow, or plan for expansion, a tailored financial structure helps you reach your goals.",
  },
  {
    question: "How does Kreditfin help with structuring my finances?",
    answer:
      "Our experts analyze your complete financial picture, optimize your debt and cash flow, and design a personalized plan with long-term monitoring and complete transparency.",
  },
  {
    question: "What documents are required?",
    answer:
      "Typically income proof, bank statements, existing loan and liability details, and asset documents. We guide you through the exact list needed for your situation.",
  },
  {
    question: "How long does the process take?",
    answer:
      "An initial financial structure plan is usually prepared within a few business days once we have your details. Ongoing monitoring continues as your goals evolve.",
  },
];
          ...
          <div className="w-full lg:flex-1 rounded-[16px] border border-[rgba(26,31,46,0.1)] p-6 sm:p-8">
            ...
            >
              <div className="flex flex-col gap-1">
                <h3 className="text-[18px] font-bold text-[#1a1f2e] leading-[26px]">Need help with your finances?</h3>
                <p className="text-[13px] text-[rgba(26,31,46,0.65)] leading-[20px] max-w-[300px]">
                  Talk to our experts and get a structure tailored to your needs.
                </p>
              </div>
              <Link
                href="/contact"
...
export default function FinancialStructuringPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full relative overflow-hidden bg-[#fdfdfd]">
        ...
        <div className="hidden lg:block absolute right-0 top-0 bottom-0 w-[55%] max-w-[800px]">
          <Image
            src="/assets/financial-structuring-hero-illustration.png"
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px] py-12 lg:py-0 flex flex-col lg:flex-row items-center lg:min-h-[480px]">
          <div className="flex flex-col gap-6 w-full lg:max-w-[540px] z-10">
            <h1 className="text-[30px] sm:text-[44px] lg:text-[52px] font-extrabold leading-[38px] sm:leading-[54px] lg:leading-[60px]">
              <span className="text-[#1a1f2e]">Financial Structuring</span><br /><span className="text-[#4caf50]">Organize. Optimize. Grow.</span>
            </h1>
            <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[26px] sm:leading-[30px] max-w-[500px]">
              Organize your loans, assets, liabilities, and cash flows into a smarter financial structure that reduces costs, improves liquidity, and supports long-term growth.
            </p>
          ...
          <div className="lg:hidden w-full relative aspect-[1458/712] mt-6 rounded-[16px] overflow-hidden">
            <Image src="/assets/financial-structuring-hero-illustration.png" alt="Financial structuring" fill priority sizes="100vw" className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 lg:px-[100px] text-center">
          <h2 className="text-[26px] sm:text-[32px] font-bold text-[#1a1f2e] leading-[34px] sm:leading-[40px]">What Is Financial Structuring?</h2>
          <p className="text-[15px] sm:text-[18px] text-[rgba(26,31,46,0.7)] mt-4 leading-[26px] sm:leading-[30px]">
            Financial Structuring is the process of organizing your loans, assets, liabilities, cash flows, and financing arrangements to improve financial efficiency and achieve long-term financial goals. Whether you&apos;re an individual, professional, or business owner, the right financial structure can reduce costs, improve liquidity, and support future growth.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="See How Financial Structuring Works" sub="Understand the simple process of getting your finances structured for efficiency and long-term growth." />
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Why Choose Kreditfin for Financial Structuring" sub="We combine creative thinking with data-driven strategies to deliver results that matter for your financial journey." />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[28px] max-w-[545px]">
                Tell us about your financial requirements and our experts will guide you toward the most suitable structuring options with complete transparency and personalized support.
              </p>
              <div className="flex flex-col gap-5 mt-2">
                {[
                  { title: "Share Your Requirements", desc: "Tell us about your financial goals and current arrangements.", icon: <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM14 2v6h6M9 13l2 2 4-4" stroke="#1a1f2e" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" /> },
                  { title: "Speak With An Expert", desc: "Our specialists will review details and recommend the best structure.", icon: <path d="M4 13v-1a8 8 0 0116 0v1M4 13a2 2 0 012 2v2a2 2 0 01-4 0v-2a2 2 0 012-2zM20 13a2 2 0 00-2 2v2a2 2 0 004 0v-2a2 2 0 00-2-2zM18 17a6 4 0 01-6 4" stroke="#1a1f2e" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" /> },
                ].map((f) => (
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 shadow-[0_4px_40px_rgba(0,0,0,0.06)] flex flex-col gap-5">
              <LeadForm subject="New KreditFin enquiry (Financial Structuring)" />
            </div>
          </div>
        </div>
      </section>
