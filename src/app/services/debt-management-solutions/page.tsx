...
const whyCards = [
  { title: "Personalized Debt Plans", desc: "Strategies tailored to your financial condition and repayment capacity." },
  { title: "Lower Financial Stress", desc: "Simplify payments and improve cash flow management." },
  { title: "Financial Wellness", desc: "Build healthier financial habits and achieve sustainable stability." },
  { title: "Dedicated Assistance", desc: "Dedicated support throughout the application process." },
];

const whyIcons = [
  // personalized plans (clipboard / plan)
  <svg key="0" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M9 3h6a1 1 0 011 1v1h2a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V6a1 1 0 011-1h2V4a1 1 0 011-1zM8 5v1h8V5M8.5 12l2 2 4-4" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // lower stress (smile / relief)
  <svg key="1" width="28" height="28" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="#4caf50" strokeWidth="1.6" /><path d="M8 14s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // financial wellness (heart / pulse)
  <svg key="2" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M20.8 6.6a5 5 0 00-7.1 0L12 8.3l-1.7-1.7a5 5 0 10-7.1 7.1L12 21.5l8.8-7.8a5 5 0 000-7.1z" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // support (headset)
...
const beforeRows = ["Generic Advice", "Lengthy Documentation", "No Long-Term Monitoring", "Limited Financial Visibility"];
const afterRows = ["Personalized Financial Plans", "Minimal Paperwork", "Long-Term Wealth Planning", "Complete Financial Analysis"];

const rowIconPaths = [
  "M3 6h13M3 12h9M3 18h13M18 9l3 3-3 3", // plan / advice
  "M12 2l2.4 7.4H22l-6 4.5 2.3 7.1L12 16.6 5.7 21l2.3-7.1-6-4.5h7.6z", // star / personalized
  "M12 8v4l3 2M21 12a9 9 0 11-18 0 9 9 0 0118 0z", // clock / monitoring
  "M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3zM9 12l2 2 4-4", // shield-check / visibility
];
...
const quickSteps = [
  { title: "Share Your Details", desc: "Provide your current debts and loan information." },
  { title: "Get a Custom Debt Plan", desc: "We design a repayment strategy that fits your capacity." },
  { title: "Become Debt-Free", desc: "Make one simplified payment and regain financial control." },
];

const faqs = [
  {
    question: "What are Debt Management Solutions?",
    answer:
      "Debt Management Solutions help you organize and repay multiple debts through a personalized plan tailored to your financial condition and repayment capacity — simplifying payments, lowering stress, and improving your overall financial wellness.",
  },
  {
    question: "How does Kreditfin help me manage my debt?",
    answer:
      "We assess your complete debt picture, design a personalized repayment strategy, simplify your payments, and provide dedicated support and guidance so you can build healthier financial habits.",
  },
  {
    question: "Will a debt management plan affect my credit score?",
    answer:
      "A well-structured plan that keeps payments on time typically helps your credit profile over time. Our advisors guide you on the approach that best protects and improves your score.",
  },
  {
    question: "Can I include credit card dues and loans together?",
    answer:
      "Yes. We can bring together credit card dues, personal loans, and other obligations into one simplified, manageable repayment plan.",
  },
  {
    question: "How long does the process take?",
    answer:
      "Once we have your details, an initial debt management plan is usually prepared within a few business days, with ongoing support as you progress toward becoming debt-free.",
  },
];
          ...
          <div className="w-full lg:flex-1 rounded-[16px] border border-[rgba(26,31,46,0.1)] p-6 sm:p-8">
            ...
            >
              <div className="flex flex-col gap-1">
                <h3 className="text-[18px] font-bold text-[#1a1f2e] leading-[26px]">Need help managing your debt?</h3>
                <p className="text-[13px] text-[rgba(26,31,46,0.65)] leading-[20px] max-w-[300px]">
                  Talk to our experts and get a repayment plan tailored to your needs.
                </p>
              </div>
              <Link
                href="/contact"
...
export default function DebtManagementSolutionsPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full relative overflow-hidden bg-[#fdfdfd]">
        ...
        <div className="hidden lg:block absolute right-0 top-0 bottom-0 w-[48%] max-w-[720px]">
          <Image
            src="/assets/debt-management-hero-illustration.png"
            alt="Debt management solutions"
            fill
            priority
            sizes="48vw"
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px] py-12 lg:py-0 flex flex-col lg:flex-row items-center lg:min-h-[480px]">
          <div className="flex flex-col gap-6 w-full lg:max-w-[560px] z-10">
            <h1 className="text-[30px] sm:text-[44px] lg:text-[52px] font-extrabold leading-[38px] sm:leading-[54px] lg:leading-[60px]">
              <span className="text-[#1a1f2e]">Debt Management</span><br /><span className="text-[#4caf50]">One Simplified Payment</span>
            </h1>
            <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[26px] sm:leading-[30px] max-w-[500px]">
              Bring your credit card bills, loans, and other dues together into one manageable payment — with a personalized plan that lowers stress and rebuilds your financial wellness.
            </p>
          ...
          <div className="lg:hidden w-full relative aspect-[877/530] mt-6 rounded-[16px] overflow-hidden">
            <Image src="/assets/debt-management-hero-illustration.png" alt="Debt management solutions" fill priority sizes="100vw" className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 lg:px-[100px] text-center">
          <h2 className="text-[26px] sm:text-[32px] font-bold text-[#1a1f2e] leading-[34px] sm:leading-[40px]">What Is Debt Management Solutions?</h2>
          <p className="text-[15px] sm:text-[18px] text-[rgba(26,31,46,0.7)] mt-4 leading-[26px] sm:leading-[30px]">
            Debt Management Solutions help you organize and repay multiple debts through a personalized plan tailored to your financial condition and repayment capacity. Kreditfin simplifies your payments, lowers your financial stress, and helps you build healthier financial habits for long-term, sustainable stability.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="See How Debt Management Solutions Works" sub="Understand the simple process of consolidating your debts into one manageable, stress-free payment." />
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Why Choose Kreditfin for Debt Management Solutions" sub="We combine creative thinking with data-driven strategies to deliver results that matter for your financial journey." />
      ...
      <section className="w-full py-12 sm:py-16" style={{ background: "#eef7ee" }}>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Tips To Get Approval" sub="Reach out to us through the contact details below" />
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-10">
            ...
            <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] rounded-full bg-[#f4f8fa] flex items-center justify-center shrink-0">
              <Image src="/assets/tips-center.png" alt="Approval checklist" width={247} height={192} unoptimized className="w-[70%] h-auto object-contain" />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[28px] max-w-[545px]">
                Tell us about your financial requirements and our experts will guide you toward the most suitable debt management options with complete transparency and personalized support.
              </p>
              <div className="flex flex-col gap-5 mt-2">
                {[
                  { title: "Share Your Requirements", desc: "Tell us about your debts, financial goals, and repayment capacity.", icon: <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM14 2v6h6M9 13l2 2 4-4" stroke="#1a1f2e" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" /> },
                  { title: "Speak With An Expert", desc: "Our specialists will review details and recommend the best plan.", icon: <path d="M4 13v-1a8 8 0 0116 0v1M4 13a2 2 0 012 2v2a2 2 0 01-4 0v-2a2 2 0 012-2zM20 13a2 2 0 00-2 2v2a2 2 0 004 0v-2a2 2 0 00-2-2zM18 17a6 4 0 01-6 4" stroke="#1a1f2e" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" /> },
                ].map((f) => (
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 shadow-[0_4px_40px_rgba(0,0,0,0.06)] flex flex-col gap-5">
              <LeadForm subject="New KreditFin enquiry (Debt Management Solutions)" />
            </div>
          </div>
        </div>
      </section>
