...
const whyCards = [
  { title: "Lower Interest Rates", desc: "Enjoy competitive interest rates with flexible terms." },
  { title: "Higher Loan Eligibility", desc: "Find the best rates available." },
  { title: "Multiple Lender Options", desc: "Compare offers from leading banks and NBFCs." },
...
const tips = [
  ...
  "Ensure Your Income Remains Stable and Well-Documented",
...
const faqs = [
  {
    ...
    answer:
      "A Personal Loan is an unsecured loan that helps you meet financial needs without pledging any collateral — useful for medical emergencies, weddings, travel, education, or debt consolidation.",
  },
  {
    question: "How much personal loan can I get?",
    answer:
      "Depending on your income, credit score, and repayment ability, you can get a personal loan of up to ₹50 Lakhs from our partner banks and NBFCs.",
  },
  {
    question: "Do I need collateral for a personal loan?",
    answer:
      "No. A personal loan is completely unsecured, so you don't need to pledge any property or asset as security to get approved.",
  },
  {
    question: "How fast can I get a personal loan?",
    answer:
      "With minimal paperwork and quick verification, personal loans are often approved within hours and disbursed within a day or two.",
  },
  {
    question: "What can I use a personal loan for?",
    answer:
      "There are no end-use restrictions — you can use the funds for medical bills, a wedding, travel, education, home improvement, or any personal requirement.",
  },
];
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full relative overflow-hidden bg-[#fdfdfd]">
        ...
        <div className="hidden lg:block absolute right-[2%] top-1/2 -translate-y-1/2 w-[40%] max-w-[600px] h-full max-h-[440px]">
          <Image
            src="/assets/personal-loan-hero-illustration.png"
            alt="Personal loan"
            fill
            priority
            sizes="40vw"
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px] py-12 lg:py-0 flex flex-col lg:flex-row items-center lg:min-h-[480px]">
          <div className="flex flex-col gap-6 w-full lg:max-w-[560px] z-10">
            <h1 className="text-[30px] sm:text-[44px] lg:text-[52px] font-extrabold leading-[38px] sm:leading-[54px] lg:leading-[60px]">
              <span className="text-[#1a1f2e]">Personal Loans</span><br /><span className="text-[#4caf50]">Quick & Hassle-Free</span>
            </h1>
            <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[26px] sm:leading-[30px] max-w-[510px]">
              Get unsecured funds up to ₹50 Lakhs for any need — weddings, travel, medical, or education — with quick approvals and minimal paperwork.
            </p>
          ...
          <div className="lg:hidden w-full relative aspect-[795/733] mt-6">
            <Image src="/assets/personal-loan-hero-illustration.png" alt="Personal loan" fill priority sizes="100vw" className="object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 lg:px-[100px] text-center">
          <h2 className="text-[26px] sm:text-[32px] font-bold text-[#1a1f2e] leading-[34px] sm:leading-[40px]">What is Personal Loan?</h2>
          <p className="text-[15px] sm:text-[18px] text-[rgba(26,31,46,0.7)] mt-4 leading-[26px] sm:leading-[30px]">
            A Personal Loan is an unsecured loan that helps you meet financial requirements without pledging any collateral. Whether you need funds for medical emergencies, weddings, travel, education, debt consolidation, or home improvements, Personal Loans offer quick access to financing with flexible repayment options.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="See How Personal Loan Works" sub="Understand the simple process of applying for a personal loan and receiving funds quickly for your financial needs." />
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Why Choose Kreditfin for Personal Loan" sub="We combine creative thinking with data-driven strategies to deliver results that matter for your financial journey." />
      ...
      <section className="w-full py-12 sm:py-16" style={{ background: "#eef7ee" }}>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Tips To Get Personal Loan Approval" sub="Reach out to us through the contact details below" />
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 shadow-[0_4px_40px_rgba(0,0,0,0.06)] flex flex-col gap-5">
              <LeadForm subject="New KreditFin enquiry (Personal Loans)" />
            </div>
          </div>
        </div>
      </section>
