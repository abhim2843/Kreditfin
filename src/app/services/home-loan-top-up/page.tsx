...
const whyCards = [
  { title: "Higher Loan Eligibility", desc: "Access additional funds based on your property value and repayment record." },
  { title: "Lower Interest Rates", desc: "Enjoy rates significantly lower than personal loans." },
  { title: "Fast Processing", desc: "Quick assessment and faster approvals." },
...
const whyIcons = [
  ...
  <svg key="2" width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M13 2L3 14h7l-1 8 10-12h-7l1-8z" stroke="#4caf50" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  // support (headset)
...
const beforeRows = ["Limited lender options", "Higher Personal Loan Rates", "Slow Approval Process", "Generic Solutions"];
const afterRows = ["Multiple lender comparison", "Lower Interest Rates", "Faster approvals", "Personalized Guidance"];
...
const tips = [
  ...
  "Keep Home Loan Documents Ready",
...
const quickSteps = [
  ...
  { title: "Receive Additional Funds", desc: "Choose the best offer and access funds quickly." },
];
...
const faqs = [
  {
    ...
    answer:
      "A Home Loan Top-Up is an additional loan offered over and above your existing home loan, using the same property as security — without needing a new loan from scratch.",
  },
  {
    question: "How much top-up loan can I get?",
    answer:
      "The amount depends on your property's current value, your outstanding home loan, and your repayment record. It's typically capped by the lender's loan-to-value limits.",
  },
  {
    question: "What can I use a top-up loan for?",
    answer:
      "There are no end-use restrictions — you can use the funds for home renovation, education, medical expenses, business needs, or any personal requirement.",
  },
  {
    question: "Why is a top-up cheaper than a personal loan?",
    answer:
      "Because it's secured against your property and the lender already has your repayment history, top-up loans usually carry interest rates far lower than personal loans.",
  },
  {
    question: "How quickly is a top-up loan approved?",
    answer:
      "Since documentation is minimal and your profile is already with the lender, top-up loans are processed and approved faster than fresh loans — often within a few days.",
  },
];
...
export default function HomeLoanTopUpPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full relative overflow-hidden bg-[#fdfdfd]">
        ...
        <div className="hidden lg:block absolute right-[2%] top-1/2 -translate-y-1/2 w-[40%] max-w-[600px] h-full max-h-[440px]">
          <Image
            src="/assets/topup-hero-illustration.png"
            alt="Home loan top-up"
            fill
            priority
            sizes="40vw"
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px] py-12 lg:py-0 flex flex-col lg:flex-row items-center lg:min-h-[480px]">
          <div className="flex flex-col gap-6 w-full lg:max-w-[560px] z-10">
            <h1 className="text-[30px] sm:text-[44px] lg:text-[52px] font-extrabold leading-[38px] sm:leading-[54px] lg:leading-[60px]">
              <span className="text-[#1a1f2e]">Home Loan</span><br /><span className="text-[#4caf50]">Top-Up</span>
            </h1>
            <p className="text-[16px] sm:text-[18px] text-[rgba(26,31,46,0.7)] leading-[26px] sm:leading-[30px] max-w-[510px]">
              Get additional funds over and above your existing home loan — at low interest rates, with minimal paperwork and faster approvals.
            </p>
          ...
          <div className="lg:hidden w-full relative aspect-[755/606] mt-6">
            <Image src="/assets/topup-hero-illustration.png" alt="Home loan top-up" fill priority sizes="100vw" className="object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-8 lg:px-[100px] text-center">
          <h2 className="text-[26px] sm:text-[32px] font-bold text-[#1a1f2e] leading-[34px] sm:leading-[40px]">What is Home Loan Top-Up?</h2>
          <p className="text-[15px] sm:text-[18px] text-[rgba(26,31,46,0.7)] mt-4 leading-[26px] sm:leading-[30px]">
            A Home Loan Top-Up is an additional loan offered over and above your existing home loan. Since the lender already has your repayment history, top-up loans often come with competitive interest rates, minimal documentation, and faster approvals compared to personal loans.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="See How Home Loan Top-up Works" sub="Access additional funds against your existing home loan with minimal paperwork and competitive interest rates." />
      ...
      <section className="w-full bg-[#f9fafc] py-12 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <SectionHead title="Why Choose Kreditfin for Home Loan Top-Up" sub="We combine creative thinking with data-driven strategies to deliver results that matter for your financial journey." />
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[100px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 shadow-[0_4px_40px_rgba(0,0,0,0.06)] flex flex-col gap-5">
              <LeadForm subject="New KreditFin enquiry (Home Loan Top Up)" />
            </div>
          </div>
        </div>
      </section>
